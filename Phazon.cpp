/****************************************************************************\
          Character Tracking Program, Made for PhazonElite
                     (c) 2009 By: RehdBlob
\****************************************************************************/
#include <fstream.h>
#include <stdlib.h>
...
ifstream in;
ofstream out;
out.open("phazon.txt", ios::app);
in.open("phazon.txt", ios::in);
in >> c1;
if (!in.eof())
   {
   out.close();
...
if (choice == '1')
   {
   cout << "The text file containing your character information, phazon.txt,\n";
